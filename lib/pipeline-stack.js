...
class PipelineStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const ssmParameter = new ssm.StringParameter(this, 'webcrawler-assets-bucket-location', {
      parameterName: 'webcrawler-assets-bucket-location',
    ...
    const deployDevAction = new codepipeline_actions.CloudFormationCreateUpdateStackAction({
      actionName: 'project3-deploy-dev',
      stackName: props.devApplicationStack.stackName,
      adminPermissions: true,
      templatePath:  buildCDKArtifacts.atPath(`${props.devApplicationStack.stackName}.template.json`),
      parameterOverrides: {
        ...props.devApplicationStack.lambdasCode.assign(buildLambdaArtifacts.s3Location),
      },
