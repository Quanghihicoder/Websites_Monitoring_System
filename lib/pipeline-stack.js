...
class PipelineStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    // const deleteBetaAction = new codepipeline_actions.CloudFormationDeleteStackAction({
    //   actionName: "DeleteBeta",
    //   stackName: props.betaApplicationStack.stackName,
    //   adminPermissions: true,
    // })
    ...
    const deleteBetaActions = props.betaApplicationStacks.map((stack,index) => new codepipeline_actions.CloudFormationDeleteStackAction({
      actionName: `DeleteBeta-${stack.region}`,
      stackName: stack.stackName,
      adminPermissions: true,
      runOrder: index + 1
    }));
    ...
    const pipeline = new codepipeline.Pipeline(this, 'Pipeline', {
      ...
      stages: [
        ...
        {
          stageName: 'DeleteBeta',
          actions: deleteBetaActions
        }
      ]
    });
