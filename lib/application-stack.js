...
class ApplicationStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    // Websites APIs
    const websitesLogGroup = new logs.LogGroup(this, "WebsitesLogGroup", {
      logGroupName: "websites-loggroup" + "-" + props.stage,
      removalPolicy: RemovalPolicy.DESTROY
    });
    ...
    const websitesAPI = new apigateway.RestApi(this, 'WebsitesAPI', {
      ...
      deployOptions: {
        accessLogDestination: new apigateway.LogGroupLogDestination(websitesLogGroup),
    ...
    // Deploy API
    const websiteAPIDeployment = new apigateway.Deployment(this, 'WebsitesAPIDeployment', {
      api: websitesAPI,
      stageName: "prod"
    });
