...
class ApplicationStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const websitesAPI = new apigateway.RestApi(this, 'WebsitesAPI', {
      restApiName: "websites-dynamodb-api",
    ...
    allWebsitesResources.addMethod('GET', getAllIntegration);
    allWebsitesResources.addMethod('POST', createIntegration);
    websiteResource.addMethod('PUT', updateIntegration);
    websiteResource.addMethod('DELETE', deleteIntegration);
