...
class ApplicationStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    // ======================================================== S3 =====================================================
    const assetsBucket = new s3.Bucket(this, 'project3-webcrawler-bucket' + "-" + props.env.region + "-" + props.stage, {
      bucketName: 'project3-webcrawler-bucket' + "-" + props.env.region + "-" + props.stage,
      removalPolicy: RemovalPolicy.DESTROY,
      autoDeleteObjects: true,
    });

    // Uncomment after run "cdk deploy" command and push to git to test the pipeline
    // const testBucket = new s3.Bucket(this, 'project3-test-bucket' + "-" + props.env.region + "-" + props.stage, {
    //   bucketName: 'project3-test-bucket' + "-" + props.env.region + "-" + props.stage,
    //   versioned: false,
    //   removalPolicy: RemovalPolicy.DESTROY,
    //   autoDeleteObjects: true,
    // });
    ...
    new s3deployment.BucketDeployment(this, 'webcrawler-bucket-deployment' + "-" + props.env.region + "-" + props.stage, {
    ...
    // const bucketNameParam = new CfnParameter(this,'project3-webcrawler-bucketname-parameter' + "-" + props.env.region + "-" + props.stage,  {
    //   default: 'lambda-deployments',
    // });
    // const objectKeyParam = new CfnParameter(this, 'project3-webcrawler-bucketobject-parameter' + "-" + props.env.region + "-" + props.stage, {
    //   default: 'lambda.zip',
    // });
    ...
    const webcrawlerAlias = new lambda.Alias(this, 'project3-webcrawler-alias' + "-" + props.env.region + "-" + props.stage, {
      aliasName: "webcrawleralias" + "-" + props.env.region + "-" + props.stage,
