...
class ApplicationStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const webcrawlerCPUAlarm = new Alarm(this, 'webcrawler-cpu-alarm' + "-" +  props.stage, {
    ...
    const webcrawlerMemmoryAlarm = new Alarm(this, 'webcrawler-memmory-alarm' + "-" +  props.stage, {
