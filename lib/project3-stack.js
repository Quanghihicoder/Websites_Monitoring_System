...
class Project3Stack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const deployPrepareAction = new codepipeline_actions.CloudFormationCreateReplaceChangeSetAction({
      actionName: 'CloudFormationPrepareChanges',
      stackName: props.stackName,
    ...
    const deployExecuteAction = new codepipeline_actions.CloudFormationExecuteChangeSetAction({
      actionName: 'CloudFormationExecuteChanges',
      stackName: props.stackName,
      changeSetName: 'StagedChangeSet',
      runOrder: 2,
    })
    ...
    // Deploy Lambda
    // const canaryDeployApplication = new codedeploy.LambdaApplication(this, 'project3-codedeploy-application', {
    //   applicationName: 'project3-codedeploy-application', 
    // });

    // canaryDeployApplication.applyRemovalPolicy(RemovalPolicy.DESTROY);

    // const alias = new lambda.Alias(this, 'project3-canary-alias', {
    //   aliasName: 'project3-canary-alias',
    //   version: canary.currentVersion,
    // });
      ...
      stages: [
        {
          ...
          actions: [deployPrepareAction,deployExecuteAction]
        }
      ]
    });
  }
