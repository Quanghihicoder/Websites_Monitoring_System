...
const sendLatencyMetric = async (latencyValue,url) => {
    const command = {
      MetricData: [
        {
          MetricName: "LatencyAkila",
          Dimensions: [
            {
              Name: "url",
              Value: url,
      ...
      Namespace: "MyApplicationAkila",
    };
  
    try {
      await cloudWatch.putMetricData(command).promise();
    } catch (err) {
